        ...
        <div className="fondo-azul animated fadeIn">
            <div className="fase2-agua border-bottom-radius">
                ...
                <div className="box-fase2-agua">
                    <p className="p-mobile-blue mt-2">En el componente Agua Segura se probaron cuatro tipos de intervenciones basadas en las ciencias del comportamiento y diseñadas junto a aliados locales e internacionales.</p>
                </div>
                        ...
                        <div className="row">
                            <div className="col-md-4 ">
                                <div className="card mb-2 card-crecer">
                                        <img className="card-img-top " src={limpios}
                            ...
                            <div className="col-md-4 clearfix d-none d-md-block">
                                <div className="card mb-2 card-crecer">
                                        <img className="card-img-top " src={sanitaria}
                                        alt="Card image cap"/>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 clearfix d-none d-md-block">
                                <div className="card mb-2 card-crecer">
                                        <img className="card-img-top " src={feria}
                                        alt="Card image cap"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 clearfix clearfix d-none d-md-block">
                                <div className="card mb-2 card-crecer">
                                        <img className="card-img-top " src={organizaciones}
                                        alt="Card image cap"/>
                                </div>
                            </div>
            ...
            <div className="text-white box-azul-agua">
                ...
                <div className="box-foto">
                    ...
                    <p className="text-aguamarina">En escuelas iniciales, promovemos el aprendizaje basado en el juego en temas de agua, saneamiento e higiene</p>
                </div>
            ...
            <div className="fondo-blanco box-blanco-agua">
                ...
                <div className="fondo-celeste fondo-celeste-agua">
                    <div className="titulo-taller">
                        <h5>Feria Familiar + Compromiso de lavado de manos</h5>
                    </div>
                    <p className="">Stands con actividades basadas en la ciencia conductual que promueven buenas prácticas de higiene personal como el lavado de manos.</p>
