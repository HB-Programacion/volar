        ...
        <div className="animated fadeIn">
            ...
            <div className="box-infografia border-top-radius ">
                ...
                <div className="box-botones-fase">
                    <a href="https://volar.org.pe/static/media/pdf/modelos-culturales.pdf" download="Antes-de-caminar-y-hablar-final2018" className="wobble-hor-bottom link" target="_blank">
                    ...
                    <a href="https://volar.org.pe/static/media/pdf/VOLAR_REPORTE.pdf" download="Memoria-de-volar"  className="wobble-hor-bottom"  target="_blank">
