         ...
         <i onClick={()=>{history.goBack()}} className="fas fa-chevron-left arrowGoback-docente goBack-docente" aria-hidden="true"></i>
            <div className="row sin-margin-row">
                <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 box-modulos-textos">
                    ...
                    <p className="p-mobile-blue">Reconocer los distintos estilos de dar de 
comer.</p>
                    <p className="p-mobile-blue">Identificar que practicas favorecen la 
alimentación responsiva.</p>
                    <p className="p-mobile-blue">Desarrollar la habilidad de responder al 
niño, a través de la comunicación verbal, el 
trato afectuoso durante el momento de la 
comida. </p>
                </div>
                <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 box-modulos-textos">
                    <h3 className="title-modulos-aliados">¡No olvidar! </h3>
                    <p className="p-mobile-blue">Alimentación responsiva implica 
desarrollar la habilidad de responder al 
niño, a través de la comunicación verbal, 
tener un trato afectuoso y animarlo para 
que el niño disfrute el momento de la 
comida.</p>
                    <p className="p-mobile-blue">El momento de la alimentación es un 
momento de disfrute, de intercambio de 
afecto y aprendizaje.</p>
                </div>
            </div>
            ...
            <div className="row sin-margin-row box-materiales-modulos">
                <div className="col-sm-12 col-md-12 col-lg-4 col-xl-4 m-auto ">
                    ...
                    <div className="btn-modulos-info">
                        ...
                        <div className="btn-info-text">Infografía alimentación 
balanceada según edad</div>
                    </div>
                    <div className="btn-modulos-info">
                        <figure className="btn-infografia">
                            <img src={infografia} alt="" className="w-100"/>
                        </figure>
                        <div className="btn-info-text">Infografía  ¿Qué debemos 
darle de comer a un niño/
niña enfermo/a?</div>
                    </div>
                </div>
