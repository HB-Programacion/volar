  ...
  return (
    <div className="animated fadeIn">
      <Helmet>
        ...
        <meta
          property="og:image"
          content="https://volar.org.pe/static/media/banerD1.50e030d2.png"
        />
      ...
      <div className="text-center text-white text-proposito">
        ...
        <p className="">
          Darle a cada niña y niño, en su infancia temprana, la oportunidad de
          poder desarrollar al máximo las habilidades necesarias para su
          desarrollo integral.
        </p>
        <p className="">
          Los bebés nacen listos para aprender.<br></br>
          <strong className="fuerte-desktop">
            ¡Y tú tienes todo para ayudarlos!
          </strong>{" "}
        </p>
